...
--DEMO mit Spieltabelle siehe ...: Z_Spieltabelle.sql
...
--> 1   NCL IX
 ...
 --Gruppierter Columnstore auf Tabelle KU2
 --
 select * from sys.dm_db_column_store_row_group_physical_stats


 select city, sum(unitprice*quantity) from ku2
where
	city = 'Berlin'
group by city  
...
Wie hoch ist der Umsatz pro Stadt, die wo land = Germany
